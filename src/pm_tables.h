...
void pm_table_0x380904(pm_table *pmt, void* base_addr); //5600X: Zen3,  8 cores, version 4
void pm_table_0x380905(pm_table *pmt, void* base_addr); //5600X: Zen3,  8 cores, version 5
void pm_table_0x380804(pm_table *pmt, void* base_addr); //5900X: Zen3, 16 cores, version 4
void pm_table_0x380805(pm_table *pmt, void* base_addr); //5900X: Zen3, 16 cores, version 5
